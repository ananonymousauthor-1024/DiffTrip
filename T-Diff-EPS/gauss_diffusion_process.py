...
class GaussianDiffusion(nn.Module):
    ...
    def forward(self, venue_input, masked_venue_input, hour_input, masked_hour_input):
        ...
        # add input to diffusion model to predict epsilon
        noise = self.diffusion_model(x_t_hat, x_ob, t)  # [b,l,2d]
        x_0_hat = ((extract(self.sqrt_recip_alphas_bar, t, x_0.shape)) *
                   (x_t_hat - extract(self.sqrt_one_minus_alphas_bar, t, x_0.shape) * noise))
