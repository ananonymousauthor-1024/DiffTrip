...
class TrajectoryDataset(Dataset):
    ...
    def __getitem__(self, index) -> T_co:
        ...
        return masked_venue_ids, masked_hour_ids, venue_ids, masked_latitudes, masked_longitudes
